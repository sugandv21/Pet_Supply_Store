...
SECRET_KEY = 'django-insecure-2^a%qw1qw6_(q3!c@siw1#30k_jg*dkfts2t&%cho_@c=ewamw'
...
SIMPLE_JWT = {
    ...
    "ROTATE_REFRESH_TOKENS": os.getenv("ROTATE_REFRESH_TOKENS", "False").lower() in ("1", "true", "yes"),
    "BLACKLIST_AFTER_ROTATION": os.getenv("BLACKLIST_AFTER_ROTATION", "False").lower() in ("1", "true", "yes"),
