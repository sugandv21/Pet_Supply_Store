...
// NEW: import useCart from your context
...
export default function Navbar() {
  ...
  // -----------------------------
  // CART COUNT LOGIC (safe)
  // -----------------------------
  // Use the CartContext if available but fail gracefully if not wrapped in provider
  let cartCount = 0;
  try {
    ...
    // If useCart throws because provider is missing, fall back to 0.
    cartCount = 0;
  }
        ...
        <div className="px-4 lg:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="flex items-center gap-4">
              {/* Hide logo on mobile when search is open */}
              {!showMobileSearch && (
                logo ? (
            ...
            <div className="hidden lg:flex items-center gap-6">
              ...
              {/* Desktop cart with badge (render only when count > 0) */}
...
//               ) : (
//                 <div className="text-white text-xl font-bold">PetPalooza</div>
//               )}
//             </div>
